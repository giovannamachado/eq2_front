...
import '../../features/operation/models/connection_status.dart';
...
class SocketClient {
  ...
  Future<void> connect() async {
    ...
    try {
      ...
      throw const AppException('Não foi possível conectar ao rosbridge_server');
    }
  }
  ...
  void _send(Map<String, dynamic> payload) {
    ...
    if (channel == null) {
      throw const AppException('SocketClient: chame connect() antes de usar o canal.');
    }
